...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .navigationTitle(model.monitor.selectedDevice?.displayName ?? "Bottle")
        ...
        .toolbar {
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                .help("Show exactly what Bottle is running (⌘⇧L)")
            }
        }
    ...
    var body: some View {
        ContentUnavailableView {
            ...
            VStack(spacing: 10) {
                ...
                Text("Wi-Fi isn't enough — Bottle needs the cable to change what's on the phone.")
...
struct ConfiguratorMissingView: View {
    var body: some View {
        ContentUnavailableView {
            ...
            Text("Bottle drives Apple's own Apple Configurator to talk to your iPhone. Install it from the Mac App Store — it's free — then come back.")
        } actions: {
...
struct WindowConfigurator: NSViewRepresentable {
    func makeNSView(context: Context) -> NSView {
        ...
        DispatchQueue.main.async {
            ...
            window.setFrameAutosaveName("BottleMainWindow")
            if !window.setFrameUsingName("BottleMainWindow") {
