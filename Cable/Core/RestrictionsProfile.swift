...
enum RestrictionsProfile {
    static let identifier = "com.coventrylabs.cable.app-restrictions"
    /// Identifiers earlier builds used. Treated as Cable's own and replaced on the next Apply.
    static let legacyIdentifiers: Set<String> = [
        "com.bottle.app-restrictions",             // first builds
        "com.coventrylabs.bottle.app-restrictions", // before the rename to Cable
    ]
    ...
    static func data(
        ...
        let root: [String: Any] = [
            ...
            "PayloadUUID": UUID().uuidString,
            "PayloadDisplayName": "Cable App Restrictions",
            "PayloadDescription": "Installed by Cable to \(mode == .block ? "block" : "allow") selected apps\(urls.isEmpty ? "" : " and block selected websites").",
